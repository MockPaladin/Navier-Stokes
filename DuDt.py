<<<<<<< Updated upstream:Navier-Stokes.py
...
fig, ax = plt.subplots()
quiv = ax.quiver(X[:, :, 0], Y[:, :, 0], DuDt[:, :, 0], DvDt[:, :, 0], angles='xy', scale_units='xy', scale=1e2, color='blue', alpha=0.4)
...
animation.save("sim.gif", writer=PillowWriter(fps=60), dpi=150)